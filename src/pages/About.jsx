      ...
      <div className="flex flex-col items-center text-center mb-16 max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
          ...
          <p>
            ...
            exploring real-world applications of machine learning. Currently, I’m pursuing my <span className="text-teal-400 font-semibold">
            Masters in Applied Data Science</span> at the University of Victoria,
