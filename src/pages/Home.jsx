    ...
    const fetchNews = async () => {
      try {
        const res = await fetch(
          `https://gnews.io/api/v4/search?q=technology%20AI&lang=en&country=us&max=20&apikey=9af1fd2e7e5f4eec2f2b8dca36413780`
        );
...
>
  Aspiring MS Candidate | Data Science & AI
        ...
        <p className="mt-6 text-gray-300 max-w-2xl mx-auto text-lg leading-relaxed">
          ...
          Pursuing Master's in Applied Data Science
